export default {
	...
	dashboard: {
		modelUse: '/api/running-record/count/modelUse',
		trainNumber: '/api/running-record/count/trainNumber',
		tireUse: '/api/running-car/tire/home',
		carUseCost: '/api/running-record/count/carUseCost',
		violation: '/api/running-record/violation/home',
		expireAlert: '/api/running-record/count/expireAlert',
